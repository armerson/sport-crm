    ...
    <div className="rounded-[1.5rem] border border-slate-200 bg-slate-50/80 p-4">
      ...
      >
        <div className="flex items-center gap-2">
          <svg className="size-4 text-[#123524]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <span className="text-sm font-semibold text-slate-900">
            Announcements
            {!loading ? (
              <span className="ml-2 rounded-full bg-[#123524] px-2 py-0.5 text-xs font-semibold text-white">
